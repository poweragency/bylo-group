...
## Modelli Alfa Romeo che gestiamo

- **Giulietta** — storico best-seller (uscita produzione 2020 ma ancora largamente circolante)
- **MiTo** — citycar (uscita 2018, ancora frequente)
- **Giulia** — segmento D sportivo (anche Quadrifoglio)
- **Stelvio** — SUV D (anche Quadrifoglio)
- **Tonale** — SUV C (anche PHEV Q4)
- **Junior** (ex Milano) — SUV B nuova generazione, anche elettrica
